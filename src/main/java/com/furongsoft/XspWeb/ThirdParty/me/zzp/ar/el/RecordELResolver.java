...
/**
 * <p>
 * <code>me.zzp.ar.Record</code>的EL表达式解析器。 简化<code>Record</code>对象方法调用的方式。
 * </p>
 * 
 * @author redraiment
 * @since 1.0
...
public final class RecordELResolver extends ELResolver
{
     ...
     * </p>
     * <p>
     * <code>${user.name}</code>等价于<code>${user.get("name")}</code>。
     * </p>
     * 
     * @param context
     *            EL表达式上下文
     ...
     * </p>
     * <p>
     * 等价于调用<code>Record#set(String name, Object value)</code>。
     * </p>
     * 
     * @param context
     *            EL表达式上下文

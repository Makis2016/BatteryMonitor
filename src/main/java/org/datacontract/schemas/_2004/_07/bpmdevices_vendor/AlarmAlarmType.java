...
/**
 * <p>Alarm.AlarmType的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * <p>
 * <pre>
 * &lt;simpleType name="Alarm.AlarmType">
 ...
 * 
 */
@XmlType(name = "Alarm.AlarmType")
@XmlEnum
public enum AlarmAlarmType {
    ...
    public static AlarmAlarmType fromValue(String v) {
        for (AlarmAlarmType c: AlarmAlarmType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }

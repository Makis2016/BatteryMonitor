 ...
 * </p>
 * <p>
 * 1. 欲自动生成数据库对象，需要在<code>web.xml</code>添加此监听器：
 * </p>
 * <blockquote>
 * 
 * <pre>
 ...
 * </blockquote>
 * <p>
 * 此时，在<code>Servlet</code>中调用
 * <code>getServletContext().getAttribute("dbo")</code> 就能获得{@link me.zzp.ar.DB}
 * 对象。
 * </p>
 * <p>
 * 2. 其中“dbo”为默认的属性名，要修改这个名字可通过在<code>web.xml</code>中添加上下文参数：
 * </p>
 * <blockquote>
 * 
 * <pre>
...
public class DatabaseSetup implements ServletContextListener
{
    ...
    public void contextInitialized(ServletContextEvent e)
    {
        ...
        String name = context
            .getInitParameter("jactiverecord-el-attribute-name");

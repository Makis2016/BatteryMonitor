...
import static com.furongsoft.XspWeb.ThirdParty.org.easypr.core.CoreFunc.features;
...
import com.furongsoft.XspWeb.ThirdParty.org.easypr.util.Convert;
...
public class CharsIdentify
{
    ...
    {
        loadModel(ApplicationContextHolder.getResourcePath(path));
    }

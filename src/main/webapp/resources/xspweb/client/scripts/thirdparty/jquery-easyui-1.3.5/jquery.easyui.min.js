...
return false;
}},{title:"",width:350,height:100,showType:"slide",showSpeed:600,msg:"",timeout:4000},_270);
...
var _27b="<div class=\"messager-icon messager-question\"></div>"+"<div class=\"messager-msg\">"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _27c={};
...
return {resizeC:{width:ww,left:60-1},expand:{left:0},expandP:{left:0,top:_380.top,width:60,height:_380.height},collapse:{left:-_37a.width,top:_380.top,height:_380.height}};
}else{
if(_377=="north"){
var hh=_380.height;
...
_60a(this);
_52b(this);
$(".datagrid-scroll").each(function(){
    if (jQuery.isFunction(jQuery.fn.niceScroll)) {
        $(this).niceScroll({cursorcolor:"#b2b2b2", cursoropacitymax:1,touchbehavior:false,cursorwidth:"7px",cursorborder:"0",cursorborderradius:"5px"});
    }
});
});
};
...
var comboId = "combo-" + $(_7fb).attr('id');
...
var _7fc=$("<div id='"+comboId+"' class=\"combo-panel \"></div>").appendTo("body");
...
$(_7fb).removeAttr("name").attr("comboName",name);
  ...
  $("#"+comboId).niceScroll({id:comboId,zindex:9999,cursorcolor:"#b2b2b2", cursoropacitymax:1,touchbehavior:false,cursorwidth:"7px",cursorborder:"0",cursorborderradius:"5px"});

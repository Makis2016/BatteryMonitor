...
public class Query
{
    ...
    public <T> List<T> all(RowMapper<T> rowMapper, Object... params)
    {
        return table.query(sql, rowMapper, params);
    }
    ...
    public <T> T one(RowMapper<T> rowMapper, Object... params)
    {
        limit(1);
        List<T> models = all(rowMapper, params);
        if (models == null || models.isEmpty()) {
            return null;
        }
        else {

...
public class ObjectFactory {
    ...
    private final static QName _AlarmManagerAlarmLevel_QNAME = new QName("http://schemas.datacontract.org/2004/07/BPMDevices", "AlarmManager.AlarmLevel");
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link AlarmManagerAlarmLevel }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://schemas.datacontract.org/2004/07/BPMDevices", name = "AlarmManager.AlarmLevel")
    public JAXBElement<AlarmManagerAlarmLevel> createAlarmManagerAlarmLevel(AlarmManagerAlarmLevel value) {
        return new JAXBElement<AlarmManagerAlarmLevel>(_AlarmManagerAlarmLevel_QNAME, AlarmManagerAlarmLevel.class, null, value);
    }

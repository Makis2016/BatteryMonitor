...
public class ObjectFactory {
    ...
    private final static QName _DcdcDataCurrent_QNAME = new QName("http://schemas.datacontract.org/2004/07/BPMService.Model", "Current");
    ...
    private final static QName _DcdcDataVoltage_QNAME = new QName("http://schemas.datacontract.org/2004/07/BPMService.Model", "Voltage");
    ...
    public JAXBElement<Double> createDcdcDataCurrent(Double value) {
        return new JAXBElement<Double>(_DcdcDataCurrent_QNAME, Double.class, DcdcData.class, value);
    }
    ...
    public JAXBElement<Double> createDcdcDataVoltage(Double value) {
        return new JAXBElement<Double>(_DcdcDataVoltage_QNAME, Double.class, DcdcData.class, value);
    }
    ...
    public JAXBElement<Double> createBatteryPackInfoCurrent(Double value) {
        return new JAXBElement<Double>(_DcdcDataCurrent_QNAME, Double.class, BatteryPackInfo.class, value);
    }
    ...
    public JAXBElement<Double> createBatteryPackInfoVoltage(Double value) {
        return new JAXBElement<Double>(_DcdcDataVoltage_QNAME, Double.class, BatteryPackInfo.class, value);
    }
